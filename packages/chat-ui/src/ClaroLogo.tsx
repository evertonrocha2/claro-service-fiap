 ...
 * Marca Claro em JSX.
 *
 * Vem inline em vez de <img src="claro.svg"> por um motivo prático: a marca
 * aparece branca sobre vermelho na entrada e vermelha sobre o fundo escuro do
 * console. Um <img> não recolore. Com fill em currentColor, a cor vem do CSS de
 * quem usa. O arquivo em assets/claro.svg é a mesma marca, guardado para
 * exportação e para quem precisar do SVG solto.
 */
export function ClaroLogo({ height = 22, title = 'Claro' }: { height?: number; title?: string }) {
  return (
    <svg
      viewBox="0 0 1975.68 715.68"
      height={height}
      fill="currentColor"
      role="img"
      aria-label={title}
    ...
    >
      ...
      <rect
        ...
        height="84.959198"
      />
      <rect x="1445.76" y="0" width="84.96" height="243.36" />
      <rect x="1728" y="426.24" width="247.68" height="84.96" />
    </svg>
  )
}
